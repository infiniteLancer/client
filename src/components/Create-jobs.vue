<template>
   <form action="" class="box" style="padding:5rem;display:flex;flex-direction:column;justify-content:center;">
        ...
        <div class="control has-icons-left">
            <input v-model="title" type="username" placeholder="e.g. bobsmith" class="input">
    ...
    <div class="field">
        ...
        <div class="control has-icons-left">
            <input v-model="deadline" type="text" placeholder="yyyy-mm-dd" class="input">
            <span class="icon is-small is-left">
            <i class="fa fa-envelope"></i>
            </span>
        </div>
        ...
        <div class="control has-icons-left">
            <input v-model="phone" type="phone" placeholder="+62 " class="input">
            <span class="icon is-small is-left">
